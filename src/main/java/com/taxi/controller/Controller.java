...
public class Controller {
	...
	@RequestMapping(value = "/api/user/join",method=RequestMethod.POST)//됨
	public String join(@RequestBody Map<String, Object> map) {
		JoinService joinService = new JoinService();
		return joinService.join(map);
	}
	
	@RequestMapping(value = "/api/user/idCheck",method=RequestMethod.POST)//됨
    ...
    @RequestMapping(value="/api/user/login",method=RequestMethod.POST)//됨
    public String login(@RequestBody Map<String, Object> map) {
    	LoginService loginService = new LoginService();
    	return loginService.login(map);
    }
    
    @RequestMapping(value="api/taxi/allList",method=RequestMethod.GET)//됨
    public String allList(){
    	RequestListService requestListService = new RequestListService();
    	return requestListService.requestList();
    }
    
    @RequestMapping(value="api/taxi/request",method=RequestMethod.POST)//됨
    public String request(@RequestBody Map<String, Object> map){
    	RequestService requestService = new RequestService();
    	return requestService.requestService(map);
    }
    
    @RequestMapping(value="api/taxi/response",method=RequestMethod.GET)
